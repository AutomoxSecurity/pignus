...
Testing
    Unit Tests: automox/pignus/tests/test__misc.py
...
def parse_image_dir(image_name: str) -> dict:
    """Parse an image name like "automox/secops/new", breaking it into it's repo_base
    "automox/secops", and the sub_image "new"
...
# End File: automox/pignus/src/pignus/misc.py
