...
class ImageBuilds(BaseEntityMetas):
    ...
    def __init__(self, conn=None, cursor=None):
        ...
        self.scan_interval_hours = settings.options.get("SCAN_INTERVAL_HOURS").value
        self.cluster_interval_hours = settings.options.get("CLUSTER_PRESENCE_HOURS").value
...
# End File: automox/pignus/src/pignus/collections/image_builds.py
