...
Testing
    Unit
        File        automox/pignus/tests/unit/utils/test_xlate.py
        Methods     14/14 methods currently unit tested.
                    100% Coverage!
...
def get_digest(image_str: str):
    ...
    example image_str: docker-pullable://docker.io/automox/pignus@sha256:d480d804f0c11548d6be95568
...
# End File: automox/pignus/src/pignus/utils/xlate.py
